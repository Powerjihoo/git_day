...
시험 및 점검은 문서화된 절차서에 따라 수행해야 한다. 절차서에는
                        발전사업자가 제시한 기준값과
...
(다) 대체시험이 계획된 각 기기의 해야하는 시험에 대한 대체시험의
                        비율(완성도)
...
그램에서 발전소 기기가 안전기능에 대한 수행능력을 적절히 평가하는
                        가동전 및 가동중시험을 허용
...
존재를 평가하기 위한 가동중 시험 및 검사활동을 충분히 접근하여
                        수행할 수 있는 성능의
...
펌프종합시험 유량 : 시험 중에 기계적 및 수력학적 성능저하를
                        감지하기 위해 사업자에 의해 설정된
...
될 때마다 그 사유를 명시하여야 하고，MOB 9000에 따라 문서화하여야 하며，MOB 3400의 요건을
...
펌프를 제외하고 적어도 2년에 한번씩은 종합시험을 하여야 한다. 이
                        시험동안 필요한 유량을 공급
...
(3) 수직 장축 펌프는 상부 모터 베어링 하우징에서 축방향을 포함하여 직교하는 세 방향으로 측정
...
A군 시험은 펌프가 정해진 기준점에 가능한 근접하여 운전되고，그리고 아래 항에서 기술한
                        바와
...
(5) 기준값과의 편차는 표 MOB
                        5200에 있는 제한치와 비교하며，필요시 MOB 6200에 따라
                        시정

조치를 한다. 진동 측정값은 표 MOB 5200의 경고범위나 조치범위에 표기된
                        절대 허용치 및

상대 허용치와 비교해야 한다. 예를 들어 진동이
                    6 Vr
                    또는 0.7
                        in./sec(1.7 cm/sec)를 넘으면
...
B군 시험은 펌프가 정해진 기준점에 가능한 근접하여 운전되고，그리고 아래 항에서 기술한
                        바와
...
(3) 기준점에 가능한 한 근접하도록 계통 저항을 변화시킬 수 있다. 기준점이 유량이라면，기준점

으로부터 +2% 또는 -1% 범위를 초과 하지 않아야 한다. 기준점이
                        차압이라면，기준점으로부터

+1% 또는 -2% 범위를 초과하지 않아야 한다.

(4) 기준값과의 편차는 표 MOB
                        5200에 있는 제한치와 비교하며，MOB 6200에 따라 시정조치를

하여야 한다.

MOB 5223 종합 시험절차

종합시험은 펌프가 정해진 기준점에 가능한 한 근접하여
                        운전되고，그리고 아래
                        항에서 기술한 바

와 같이 기준점으로부터 일정범위 내에서 수행하여야 한다. 표
                    MOB 3000에 열거된 시험
                        항목을 아
...
또는 -2%를 초과하지 않는 범위 내에서 가능한 한
                        기준점에 근접하도록 유량을 변화시킨 후
...
(4) 진동값을 결정하여 기준값과 비교한다. 진동측정에는 광대역 신호를 사용하며，속도 측정일

경우는 최대값을，변위 측정일 경우에는 정점사이의 값을
                        취한다.

(5) 기준값과의 편차는 표 MOB
                        5200에 있는 제한치와 비교하여 MOB 6200에 따라
                        시정조치를

한다. 진동 측정값은 표 MOB 5200의 절대허용치 및 상대허용치와
                        비교하여야 한다. 예를 들어

진동이 6 Vr 또는 0.7 in./sec(1.7
                        cm/sec)를 넘으면 펌프는 조치범위에 해당한다.
...
된다. 이 운전시간이 지난 후에 표 MOB 3000에서 요구하는 시험항목을 적어도
                        한번 이상 측정
...
(1) 계통저항을 변화시킬 수 있는 계통은 최소 유량에서부터 펌프종합시험 유량 이상까지의 범위에
                    

서 적어도 다섯 군데의 유량과 차압을 측정하여 이를 근거로
                            펌프 성능곡선을 작성해야 한다.



이중적어도 한점은 기준점으로 지정하여야
                            하며，가동중시험 결과와 비교하는데 사용해야 한다.

그러나，계통저항을 변화시킬 수 없는 계통의
                            펌프는 성능곡선을 작성할 필요가 없다.
...
A군 시험은 펌프가 정해진 기준점에 가능한 한 근접하여 운전되고，그리고 아래 항에서 기술한
                            바
...
(2) 유량이 기준점의 +2%
                        또는 -1%를 초과하지 않는 범위 내에서
                            가능한 한 기준점에 근접하도록

계통의 저항을 변화시킨 후, 차압을 확인하여 기준값과
                            비교한다. 또는 차압이 기준점의 +1%



또는 -2%를 초과하지 않는 범위 내에서
                            가능한 한 기준점에 근접하도록 유량을 변화시킨 후
...
|시험 종류|회전속도|시험항목|허용범위|경고 범위|조 大|범 위|
|^|^|^|^|^|하 한|상 한|
|(1), (2)</br>A 군 시험|N/A|Q|0.95-1.10 Q</br>r|0.93<0<0.95                                    Q</br>r|< 0.93 Q</br>r|> 1.10 Q</br>r|
|^|N/A|AP|0.95-1.10 AP</br>r|0.93< ^P<0.95                                    AP</br>r|< 0.93 ᅀ Pr|> 1.10 ᅀ Pr|
|^|< 600 rpm|v</br>d</br>(Vu)|< 2.5 Vr|2.5 y <v< 6                                    V</br>r r</br>(10.5<K<22                                    mils)</br>(266.7 <V< 558.8                                    pm)|-|> 6 V</br>r</br>(> 22                                    mils)</br>(558.8 pm)|
|^|> 600 rpm|Vu</br>(Vd)|< 2.5 ᄍ;|2.5 6 V</br>r</br>(0.325<V<0.7                                    in./sec)</br>(0.8< V<1.7                                    cm/sec)|-|> 6 V</br>r</br>(> 0.7                                    in./sec)</br>(1.7 cm/sec)|
|B 군시험|N/A|Q，</br>ᅀ p|0.90-1.10 Qr</br>0.90-1.10 ᅀP</br>r|-|< 0.90 Qr</br>< 0.90 ᅀ Pr|> l.lOQr</br>> 1.10 AP</br>r|
|(1), (2)</br>종합시험|N/A|Q|0.95-1.06 Q</br>r|0.93<幻<0.95                                    Qr|< 0.93 Qr|> 1.06 Qr|
|^|N/A|ᅀ P|0.95 〜 1.06 ᅀ                                Pr|0.93< AP<0.95                                    AP</br>r|< 0.93 AP</br>r|> 1.06 ᅀ P</br>r|
|^|< 600 rpm|v</br>d</br>(Vv)|< 2.5 V</br>r|2.5 V <V< 6                                    V</br>r r</br>(10.5<V<22                                    mils)</br>(266.7 <V< 558.8                                    pm)|-|> 6 V</br>r</br>(> 22                                    mils)</br>(558.8 pm)|
|^|> 600 rpm|Vv</br>(Vd)|< 2.5 心|2.5 K<V< 6                                    Vr</br>(0.325<y<0.7                                    in./sec)</br>(0.8< V<1.7                                    cm/sec)|-|> 6 V</br>r</br>(> 0.7                                    in./sec)</br>(1.7 cm/sec)|
...
(5) 기준값과의 편차는 표 MOB
                        5300에 있는 제한치와 비교하며，필요시 MOB 6200에 따라
                        시정

조치를 한다. 진동 측정값은 표 MOB 5300의 경고범위나 조치범위에 표기된
                        절대 허용치 및

상대 허용치와 비교해야 한다. 예를 들어 진동이
                    6 Vr
                    또는 0.7
                        in./sec(1.7 cm/secX 넘으면

펌프는 조치범위에 해당한다.

표 MOB 5300 수직장축 원심펌프시험
                        허용기준
...
<2> 회전속도 > 600
                        rpm의 변위한계, 회전속도 < 600 rpm의 속도한계는 그림
                    MOB 5200 참조

MOB 5322 B군 시험절차

B군 시험은 펌프가 정해진 기준점에 가능한 한 근접하여 운전되고，그리고 아래 항에서 기술한
                        바
...
(4) 기준값과의 편차는 표 MOB
                        5300에 있는 제한치와 비교하며，MOB 6200에 따라 시정조치를
...
(5) 기준값과의 편차는 표 MOB
                        5300에 있는 제한치와 비교하여 MOB 6200에 따라 시정조치를
                        한

다. 진동 측정값은 표 MOB 5300의 절대허용치 및 상대허용치와
                        비교하여야 한다. 예를 들어
...
(1) 용적형펌프는 표 MOB
                        3000에 지정된 항목에 대하여 펌프 설계압력 또는 이에 가까운 압력에
...
| |||||||
|---|---|---|---|---|---|---|
|시험 종류|회전속도|시험항목|허용범위|경고 범위|조치범위||
|^|^|^|^|^|하 한|상 한|
|(1). (2)</br>A 군 시험|N/A|Q|0.95〜1.10                                    Qr|0.93<Q<0.95                                    Qr|< 0.93 Q</br>r|> 1.10 Qr|
|^|N/A|P|0.93 〜 1.10                                    Pr|0.90< ^P<0.93                                ᅀP</br>r|< 0.90 AP</br>r|> 1.10 AP</br>r|
|^|< 600 rpm|v</br>d|< 2.5 V</br>r|2.5 y <v< 6                                    V</br>r r</br>(10.5<V<22                                    mils)</br>(266.7 <V< 558.8                                    um)|-|> 6 Vr</br>(> 22                                    mils)</br>(558.8 iim)|
|^|> 600 rpm|V</br>v</br>(V )</br>d|< 2.5 K|2.5 K<V< 6                                    Vr</br>(0.325<K<0.7                                    in./sec)</br>(0.8<y<1.7                                    cm/sec)|-|> 6 Vr</br>(> 0.78                                    in./sec)</br>(1.7 cm/sec)|
|B 군시험|N/A|0，|0.90 〜 1.10                                    Qr|-|< 0.90 Q</br>r|> 1.10 Qr|
|(1), ⑵</br>종합시험|N/A|Q|0.95-1.06 Q</br>r|0.93<0〈0.95                                    Qr|< 0.93 Q</br>r|> 1.06 Qr|
|^|N/A|ᅀ P|0.93 〜 1.06                                    APr|0.90< ^P<0.93                                ᅀP</br>r|< 0.90 Pr|> 1.06 Pr|
|^|< 600 rpm|v</br>d</br>(Vu)|< 2.5 V</br>r|2.5 V <V< 6                                    Vr</br>r</br>(10.5<V<22                                    mils)</br>(266.7 <V< 558.8                                    pm)|-|> 6 Vr</br>(> 22                                    mils)</br>(558.8 iim)|
|^|> 600 rpm|V</br>v</br>(V )</br>d|< 2.5 V</br>r|2.5 V <V< 6                                    Vr</br>r</br>(0.325<K<0.7                                    in./sec)</br>(0.8< V<1.7                                    cm/sec)|-|> 6 V</br>r</br>(> 0.7                                    in./sec)</br>(1.7 cm/sec)|
...
(2) 토출압력이 기준점의 +2%
                    또는 -1%를 초과하지 않는 범위 내에서 가능한 한
                        기준점에 근접

하도록 계통의 저항을 변화시킨 후，유량을 확인하여 기준값과
                        비교한다.
...
(5) 기준값과의 편차는 표 MOB 5400-1
                    또는 5400-2에 있는 제한치와
                        비교하며，필요시
                    MOB

6200에 따라 시정조치를 한다. 왕복펌프의 진동 측정값은 표 MOB 5400-2의 경고범위나
                        조치

범위에 표기된 상대 허용치와 비교하여야 한다. 기타 용적형펌프의 진동
                        측정값은 표 MOB

5400-1 의 경고범위나 조치범위에 표기된 절대허용치 및 상대허용치와 비교하여야 한다. 예를

들어 진동이 6 Vr 또는 0.7 in./sec(1.7
                        cm/sec)를 넘으면 펌프는 조치범위에 해당한다.
...
|시험 종류|회전속도|시험항목|허용범위|경고 범위|조치범위||
|^|^|^|^|^|하 한|상 한|
|A 군 시험|N/A|Q|0.95-1.10 Q</br>r|0.93<Q<0.95                                Qr|< 0.93 Qr|> 1.10 Qr|
|^|N/A|P|0.93-1.10 P</br>r|0.90<P<0.93                                P</br>r|< 0.90 Pr|> 1.10 Pr|
|^|N/A|v</br>d|< 2.5 Vr|2.5 K<V< 6                                V</br>r|-|> 6 Vr|
|B 군시험|N/A|Q|0.90-1.10 Qr|-|< 0.90 Qr|> 1.10 Qr|
|종합시험|N/A|Q|0.95-1.06 Qr|0.93<Q<0.95                                Q</br>r|< 0.93 Qr|> 1.06 Qr|
|^|N/A|P|0.93 〜 1.06                                Pr|0.90<0<0.93                                Pr|< 0.93 Pr|> 1.06 Pr|
|^|N/A|V</br>d</br>（Vv）|< 2.5 Vr|2.5 K<V< 6                                V</br>r|-|> 6 V</br>r|
...
(3) 기준점에 가능한 한 근접하도록 계통 저항을 변화시킬 수 있다. 토출압력이 기준점의 +1%

또는 -2%를 초과하지 않는 범위 내에서 가능한 한
                        기준점에 근접하도록 계통의 저항을 변화

시켜야 한다.

(4) 기준값과의 편차는 표 MOB
                        5400에 있는 제한치와 비교하며，MOB 6200에 따라 시정조치를
...
표 MOB 3000에 열거한 시험변수는 고정값만
                        제외하고, 모두 변화하는 경향을 분석하여야 한다.

MOB 6200 시정조치

MOB 6210 경고범위

시험결과가 표 MOB 5200, 표 MOB 5300 또는 표 MOB 5400의 경고범위 내에 들 경우 편차의
                        원

인을 확인하고，시정조치를 완료하거나
                    MOB 6230에 따라
                        펌프해석을 수행할 때까지 MOB 3500의
...
시험결과가 표 MOB 5200, 표 MOB 5300 또는 표 MOB 5400의 조치범위에 해당할 경우
                        편차의

원인을 확인하고 시정조치하거나，MOB 6230에 따라 펌프 해석을 수행할 때까지 펌프는 운전불능으로

판정하여야 한다.

MOB 6230 해석

펌프시험 변수가 표 MOB 5200, 표 MOB 5300 또는 표 MOB 5400의 경고범위 또는 조치범위
                        내에

있을 때，변화된 값에서 펌프의 계속사용을 위한
                        해석을 수행할 수 있다. 물론 이 해석에는 펌프의

안전기능 수행능력 확인도 포함시켜야 하며，펌프 및 계통 측면의 운전 가능성뿐만
                        아니라 펌프성능

변화원인，데이터에 의한 경향분석도 포함하여야 한다.
                        해석에서는 또한 새로운 기준값을 설정해야

하는지를 고려하고，가능하면 새 기준값의 타당성을 증명해야
                        한다. 이 해석의 결과는 시험기록에

기재하여야 한다.（MOB 9000 참조）

MOB 6300 구조적 오류

시험결과가 허용범위 이상의 큰 편차를 보일 때（표 MOB 5200, 표 MOB 5300 또는 표 MOB 5400

참조），부적절한 계통 정렬 또는 부정확한 계기
                        사용 등과 같은 구조적 오류로 판명되면 오류를 수정
...
만약，어떤 변수의 기준값이 다른 조건 때문에
                        현저하게 영향을 받을 수 있다면 이러한 조건들을
...
만약 초기 진동 측정값이 높고，이 원인이 펌프 자체의 문제가 아닌
                        것이 분명할 시에는 구동기，기초 및 배관에서의

진동을각각 측정，분석하여 측정된 진동값이 펌프의 기능을
                        저해하지 않고，기준값이 펌프의 진동값을 대표한다는 것
...
발전사업자는 이 기술기준을 적용하는 각 펌프에 대하여 다음 사항을
                        포함하는 기록을 유지하여

한다.

(1) 제작자, 제작자의 제품형식이나，일련번호 또는
                        식별번호
...
이 부록은 펌프 주기적 검증 시험을 수행하기 위한 요건을 규정하고
                        있다. MOB 1400에서 설명한

것처럼，발전사업자는 MOA 1100에 따라 시험되는 적용 가능한
                        펌프에 대해서 펌프 주기적 검증
...
펌프 주기적 검증시험(2) : 가장 높은 설계기준사고
                        유량에서，펌프가
                        요구되는 압력(차압 또는 토출압)

을 만족할 수 있는지 대해 검증하는 시험

1-3000 일반요건

발전사업자는 다음사항을 수행하여야 한다.

(1) 신뢰할 수 있는 발전사업자의 안전 분석(기술사양，기술요건 프로그램 또는 최신
                        안전분석

보고서)에 특정 설계 기준 사고 유량을 가지는 펌프
                        제시한다.

(2) 적어도 2년 한번씩 펌프 주기적 검증 시험을 수행하여야 한다.

(3) 펌프가 교체，수리 또는 유지보수 후에 사용가능하다고 선언하기 전에 펌프 주기적 검증 시험이

필요한지 결정해야 한다.

(4) 만약，펌프 주기적 검증 시험 유량 그리고 관련된 차압(또는 용적형 펌프의 경우 토출압)이

달성되지 못했다면，펌프운전 불능을 선언해야
                        한다.

(5) 적용 가능한 시험 변수(유량과 관련한 토출압，또는 유량과 관련한 차압 그리고 가변속
                        펌프의

속도) 및 그들의 기준들을 포함하여，펌프 주기적 검증 시험에 필요한 기록들은
                        유지되어야 한다.

(6) 펌프 주기적 검증 시험 기기의 정확도가 시험 허용기준 범위
                        안에 있음을 밝혀야 한다.

주 (1) 이 부록에는 MOB의 역할을 늘리기 위해 요건들을 수록하고
                        있다. 만약 발전사업자 안전분석에 나와 있는 설계기준사

고 유량이 펌프종합시험이나 A군 시험에 의해 제한되어
                        있다면，발전사업자는 펌프 주기적 검증시험을 수행할 필요는

없다.

(2) 펌프는 다른 계통사양 또는 single vs
                        parallel 펌프 운전에서 기인한 여러 설계기준 사고 후 운전점을 가질 수
                        있다.

발전소 계통의 시험을 대해 추가적인 정보를 얻기 위해서는
                    KEPIC MOF “원전 계통성능시험”을 참고하시오.
