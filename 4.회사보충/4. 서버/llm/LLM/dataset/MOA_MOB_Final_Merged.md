...
MOB 5100 일반사항
이 기술기준은 가동전시험, A, B군 및 종합시험에 대한 요건을 정한다.
...
MOB 5201 시험 시간
(1) A군시험과 종합시험은 펌프의 상태가 최대한 안정된 후，각 펌프를 적어도 2분간 운전하여야 한다. 이 운전시간이 지난 후에 표 MOB 3000에서 요구하는 시험항목을 적어도 한번 이상 측정 또는 결정하여 기록하여야 한다.
(2) B군시험은 펌프의 상태가 안정된 후 표 MOB 3000에서 요구하는 시험 항목을 적어도 한번 이상 측정 또는 결정하여 기록하여야 한다.

MOB 5202 우회배관
(1) 우회배관의 유량이 MOB 3400의 요건을 만족한다면，A군 시험 또는 종합시험에 우회시험배관을 이용할 수 있다.
(2) 우회배관을 펌프 제작자의 최소유량 운전조건(예 ； 유량，제한시간)을 만족하도록 설계한 경우에는 B군 시험에 우회시험배관을 이용할 수 있다.

MOB 5210 가동전시험
측정해야 할 변수를 표 MOB 3000에 나타내었다.
(1) 계통저항을 변화시킬 수 있는 계통은 최소 유량에서부터 펌프종합시험 유량 이상까지의 범위에서 최소한 다섯 군데의 유량과 차압을 측정하여 이를 근거로 펌프 성능곡선을 작성해야 한다. 이중적어도 한점은 기준점으로 지정하여야 하며，가동중시험 결과와 비교하는데 사용해야 한다. 그러나，계통저항을 변화시킬 수 없는 계통의 펌프는 성능곡선을 작성할 필요가 없다.
(2) 진동측정은 기준점에서 만 측정한다.

MOB 5220 가동중시험
표 MOB 5200 원심펌프시험 허용기준
| ||||||| |---|---|---|---|---|---|---| |시험 종류|회전속도|시험항목|허용범위|경고 범위|조 大|범 위| |^|^|^|^|^|하 한|상 한| |⑴，⑵</br>A군시험|N/A|Q|0.90-1.10 Q</br>r|-|< 0.90 Qr|> 1.10 Q</br>r| |^|N/A|ᅀ P|0.90 〜 1.10                                    ᅀPr|-|< 0.90 ᅀ P</br>r|> 1.10 ᅀ P</br>r| |^|<600 rpm|Vd</br>(Vv)|< 2.5 Vr|2.5 V <7< 6                                    Vr</br>r</br>(10.5<V<22                                    mils)</br>(266.7 <V< 558.8                                    um)|-|> 6 Vr</br>(> 22                                    mils)</br>(558.8 pm)| |^|>600 rpm|Vu</br>(V )</br>d|< 2.5 Vr|2.5 V <V< 6                                    V</br>r r</br>(0.325<V<0.7                                    in./sec)</br>(0.8< V<1.7                                    cm/sec)|-|> 6 V</br>r</br>(> 0.7                                    in./sec)</br>(1.7 cm/sec)| |B 군시험|N/A|Q，</br>ᅀ p|0.90 〜 1.10                                    Qr</br>0.90-1.10 AP</br>r|-|< 0.90分</br>< 0.90 AP</br>r|> 1.10 Qr</br>> 1.10 ᅀ P</br>r| |(1). (2)</br>종합시험|N/A|Q|0.94-1.06 Q</br>r|0.90<0<0.94                                    Q</br>r|< 0.90 Q</br>r|> 1.06 Q</br>r| |^|N/A|ᅀ P|0.93 〜 1.06                                    ᅀPr|0.90< AP<0.93                                    AP</br>r|< 0.90 ᅀP</br>r|> 1.06 ᅀP</br>r| |^|<600 rpm|v</br>d</br>(V )</br>v|< 2.5 V</br>r|2.5 V <V< 6                                    Vr</br>r</br>(10.5<V<22                                    mils)</br>(266.7 < V< 558.8                                    pm)|-|> 6 V</br>r</br>(> 22                                    mils)</br>(558.8 pm)| |^|>600 rpm|K</br>(V )</br>d|< 2.5 Vr|2.5 K<K< 6                                    V</br>r</br>(0.325<T，<0.7 in./sec)</br>(0.8< V<1.7                                    cm/sec)|-|> 6 V</br>r</br>(> 0.7                                    in./sec)</br>(1.7 cm/sec)|
주) Pr, Qr, Vr : 기준값
<1> Vd : 변위，Vv : 속도
<2> 회전속도 > 600 rpm의 변위한계，회전속도 < 600 rpm의 속도한계는 그림 MOB 5200 참조

MOB 5221 A군 시험절차
A군 시험은 펌프가 정해진 기준점에 가능한 근접하여 운전되고，그리고 아래 항에서 기술한 바와 같이 기준점으로부터 일정범위 내에서 수행하여야 한다. 표 MOB 3000에 열거된 시험 항목을 아래에 따라 결정하고，기록하여야 한다. 시험은 다음과 같이 수행하여야 한다.
(1) 정구동의 경우에는 펌프가 전동기 정격속도로 운전될 때，변속 구동의 경우에는 전동기 속도가 기준점 속도 ±1 %에 도달했을 때 시험을 한다.
(2) 유량이 기준점의 +2% 또는 -1%를 초과하지 않는 범위 내에서 가능한 한 기준점에 근접하도록 계통의 저항을 변화시킨 후, 차압을 확인하여 기준값과 비교한다. 또는 차압이 기준점의 +1% 또는 -2%를 초과하지 않는 범위 내에서 가능한 기준점에 근접하도록 유량을 변화시킨 후 유량을 확인하여 기준값과 비교한다.
(3) 계통의 저항을 변화시키는 것이 어려울 경우에는 유량과 압력을 결정하여 각각의 기준값과 비교한다.
(4) 진동값(변위 또는 속도)을 결정하여 기준값과 비교한다. 진동측정에는 광대역 신호를 사용하며속도 측정일 경우에는 최대값을，변위 측정일 경우에는 정점사이의 값을 취한다.
(5) 기준값과의 편차는 표 MOB 5200에 있는 제한치와 비교하며，필요시 MOB 6200에 따라 시정 조치를 한다. 진동 측정값은 표 MOB 5200의 경고범위나 조치범위에 표기된 절대 허용치 및 상대 허용치와 비교해야 한다. 예를 들어 진동이 6 Vr 또는 0.7 in./sec(1.7 cm/sec)를 넘으면 펌프는 조치범위에 해당한다.


MOB 5222 B군 시험절차
B군 시험은 펌프가 정해진 기준점에 가능한 근접하여 운전되고，그리고 아래 항에서 기술한 바와 같이 기준점으로부터 일정범위 내에서 수행하여야 한다. 표 MOB 3000에 열거된 시험 항목을 아래에 따라 결정하고，기록하여야 한다. 시험은 다음과 같이 수행하여야 한다.
(1) 정속구동의 경우에는 펌프가 전동기 정격속도로 운전될 때，변속 구동의 경우에는 전동기 속도가 기준점 속도 ±1 %에 도달했을 때 시험을 한다.
(2) 차압 또는 유량을 결정하여 기준값과 비교하여야 한다.
(3) 기준점에 가능한 한 근접하도록 계통 저항을 변화시킬 수 있다. 기준점이 유량이라면，기준점으로부터 +2% 또는 -1% 범위를 초과 하지 않아야 한다. 기준점이 차압이라면，기준점으로부터 +1% 또는 -2% 범위를 초과하지 않아야 한다.
(4) 기준값과의 편차는 표 MOB 5200에 있는 제한치와 비교하며，MOB 6200에 따라 시정조치를 하여야 한다.

MOB 5223 종합 시험절차
종합시험은 펌프가 정해진 기준점에 가능한 한 근접하여 운전되고，그리고 아래 항에서 기술한 바와 같이 기준점으로부터 일정범위 내에서 수행하여야 한다. 표 MOB 3000에 열거된 시험 항목을 아
래에 따라 결정하고，기록하여야 한다. 시험은 다음과 같이 수행하여야 한다.
(1) 정속구동의 경우에는 펌프가 전동기 정격속도로 운전될 때，변속 구동의 경우에는 전동기 속도가 기준점 속도 ±1 %에 도달했을 때 시험을 한다.
(2) 유량이 기준점의 +2% 또는 -1%를 초과하지 않는 범위 내에서 가능한 한 기준점에 근접하도록 계통의 저항을 변화시킨 후，차압을 확인하여 기준값과 비교한다. 또는 차압이 기준점의 +1% 또는 -2%를 초과하지 않는 범위 내에서 가능한 한 기준점에 근접하도록 유량을 변화시킨 후 유량을 확인하여 기준값과 비교한다.
(3) 계통의 저항을 변화시키는 것이 어려울 경우에는 유량과 압력을 결정하여 각각의 기준값과 비교한다.
(4) 진동값을 결정하여 기준값과 비교한다. 진동측정에는 광대역 신호를 사용하며，속도 측정일 경우는 최대값을，변위 측정일 경우에는 정점사이의 값을 취한다.
(5) 기준값과의 편차는 표 MOB 5200에 있는 제한치와 비교하여 MOB 6200에 따라 시정조치를 한다. 진동 측정값은 표 MOB 5200의 절대허용치 및 상대허용치와 비교하여야 한다. 예를 들어 진동이 6 Vr 또는 0.7 in./sec(1.7 cm/sec)를 넘으면 펌프는 조치범위에 해당한다.
...
11乂lull》S|!UJMOB(2015 년 판)5ICO9Q.-Ob5le9a..p>102 (2540)5 (1270)2 (508)101 (254)5 (127)2 (50.8)10° (25.4)5(12.7)2(5.1)10니 (2.5)Pump Speed, rpm
그림 MOB 5200 진동 제한치

MOB 5310 가동전시험
측정해야 할 변수를 표 MOB 3000에 나타내었다.
(1) 계통저항을 변화시킬 수 있는 계통은 최소 유량에서부터 펌프종합시험 유량 이상까지의 범위에서 적어도 다섯 군데의 유량과 차압을 측정하여 이를 근거로 펌프 성능곡선을 작성해야 한다. 이중적어도 한점은 기준점으로 지정하여야 하며，가동중시험 결과와 비교하는데 사용해야 한다. 그러나，계통저항을 변화시킬 수 없는 계통의 펌프는 성능곡선을 작성할 필요가 없다.
(2) 진동측정은 기준점에서만 측정한다.

MOB 5320 가동중시험
표 MOB 5300 수직장축 원심펌프시험 허용기준
| ||||||| |---|---|---|---|---|---|---| |시험 종류|회전속도|시험항목|허용범위|경고 범위|조 大|범 위| |^|^|^|^|^|하 한|상 한| |(1), (2)</br>A 군 시험|N/A|Q|0.95-1.10 Q</br>r|0.93<0<0.95                                    Q</br>r|< 0.93 Q</br>r|> 1.10 Q</br>r| |^|N/A|AP|0.95-1.10 AP</br>r|0.93< ^P<0.95                                    AP</br>r|< 0.93 ᅀ Pr|> 1.10 ᅀ Pr| |^|< 600 rpm|v</br>d</br>(Vu)|< 2.5 Vr|2.5 y <v< 6                                    V</br>r r</br>(10.5<K<22                                    mils)</br>(266.7 <V< 558.8                                    pm)|-|> 6 V</br>r</br>(> 22                                    mils)</br>(558.8 pm)| |^|> 600 rpm|Vu</br>(Vd)|< 2.5 ᄍ;|2.5 6 V</br>r</br>(0.325<V<0.7                                    in./sec)</br>(0.8< V<1.7                                    cm/sec)|-|> 6 V</br>r</br>(> 0.7                                    in./sec)</br>(1.7 cm/sec)| |B 군시험|N/A|Q，</br>ᅀ p|0.90-1.10 Qr</br>0.90-1.10 ᅀP</br>r|-|< 0.90 Qr</br>< 0.90 ᅀ Pr|> l.lOQr</br>> 1.10 AP</br>r| |(1), (2)</br>종합시험|N/A|Q|0.95-1.06 Q</br>r|0.93<幻<0.95                                    Qr|< 0.93 Qr|> 1.06 Qr| |^|N/A|ᅀ P|0.95 〜 1.06 ᅀ                                Pr|0.93< AP<0.95                                    AP</br>r|< 0.93 AP</br>r|> 1.06 ᅀ P</br>r| |^|< 600 rpm|v</br>d</br>(Vv)|< 2.5 V</br>r|2.5 V <V< 6                                    V</br>r r</br>(10.5<V<22                                    mils)</br>(266.7 <V< 558.8                                    pm)|-|> 6 V</br>r</br>(> 22                                    mils)</br>(558.8 pm)| |^|> 600 rpm|Vv</br>(Vd)|< 2.5 心|2.5 K<V< 6                                    Vr</br>(0.325<y<0.7                                    in./sec)</br>(0.8< V<1.7                                    cm/sec)|-|> 6 V</br>r</br>(> 0.7                                    in./sec)</br>(1.7 cm/sec)|
주) Pr, Qr, Vr : 기준값
<1> Vd : 변위，Vu : 속도
<2> 회전속도 > 600 rpm의 변위한계, 회전속도 < 600 rpm의 속도한계는 그림 MOB 5200 참조

MOB 5321 A군 시험절차
A군 시험은 펌프가 정해진 기준점에 가능한 한 근접하여 운전되고，그리고 아래 항에서 기술한 바와 같이 기준점으로부터 일정범위 내에서 수행하여야 한다. 표 MOB 3000에 열거된 시험 항목을 아래에 따라 결정하고，기록하여야 한다. 시험은 다음과 같이 수행하여야 한다.ㄴ
(1) 정속구동의 경우에는 펌프가 전동기 정격속도로 운전될 때，변속 구동의 경우에는 전동기 속도가 기준점 속도 ±1 %에 도달했을 때 시험을 한다.
(2) 유량이 기준점의 +2% 또는 -1%를 초과하지 않는 범위 내에서 가능한 한 기준점에 근접하도록 계통의 저항을 변화시킨 후, 차압을 확인하여 기준값과 비교한다. 또는 차압이 기준점의 +1% 또는 -2%를 초과하지 않는 범위 내에서 가능한 한 기준점에 근접하도록 유량을 변화시킨 후 유량을 확인하여 기준값과 비교한다.
(3) 계통의 저항을 변화시키는 것이 어려울 경우에는 유량과 압력을 결정하여 각각의 기준값과 비교한다.
(4) 진동값(변위 또는 속도)을 결정하여 기준값과 비교한다. 진동측정에는 광대역 신호를 사용하며，속도 측정일 경우에는 최대값을，변위 측정일 경우에는 정점사이의 값을 취한다.
(5) 기준값과의 편차는 표 MOB 5300에 있는 제한치와 비교하며，필요시 MOB 6200에 따라 시정조치를 한다. 진동 측정값은 표 MOB 5300의 경고범위나 조치범위에 표기된 절대 허용치 및 상대 허용치와 비교해야 한다. 예를 들어 진동이 6 Vr 또는 0.7 in./sec(1.7 cm/secX 넘으면 펌프는 조치범위에 해당한다.

MOB 5322 B군 시험절차
B군 시험은 펌프가 정해진 기준점에 가능한 한 근접하여 운전되고，그리고 아래 항에서 기술한 바와 같이 기준점으로부터 일정범위 내에서 수행하여야 한다. 표 MOB 3000에 열거된 시험 항목을 아래에 따라 결정하고，수행하여야 한다.시험은 다음과 같이 하여야한다.
(1) 정속구동의 경우에는 펌프가 전동기 정격속도로 운전될 때，변속 구동의 경우에는 전동기 속도가 기준점 속도 ±1 %에 도달했을 때 시험을 한다.
(2) 차압 또는 유량을 결정하여 기준값과 비교하여야 한다.
(3) 기준점에 가능한 한 근접하도록 계통 저항을 변화시킬 수 있다. 기준점이 유량이라면，기준점으로부터 +2% 또는 -1% 범위를 초과 하지 않아야 한다. 기준점이 차압이라면，기준점으로부터 +1% 또는 -2% 범위를 초과하지 않아야 한다.
(4) 기준값과의 편차는 표 MOB 5300에 있는 제한치와 비교하며，MOB 6200에 따라 시정조치를 하여야 한다.

MOB 5323 종합 시험절차
종합시험은 펌프가 정해진 기준점에 가능한 근접하여 운전되고，그리고 아래 항에서 기술한 바와 같이 기준점으로부터 일정범위 내에서 수행하여야 한다. 표 MOB 3000에 열거된 시험 항목을 아래에 따라 결정하고，기록하여야 한다. 시험은 다음과 같이 수행하여야 한다.
(1) 정속구동의 경우에는 펌프가 전동기 정격속도로 운전될 때，변속 구동의 경우에는 전동기 속도가 기준점 속도 ±1 %에 도달했을 때 시험을 한다.
(2) 유량이 기준점의 +2% 또는 -1%를 초과하지 않는 범위 내에서 가능한 한 기준점에 근접하도록 계통의 저항을 변화시킨 후，차압을 확인하여 기준값과 비교한다. 또는 차압이 기준점의 +1% 또는 -2%를 초과하지 않는 범위 내에서 가능한 한 기준점에 근접하도록 유량을 변화시킨 후 유량을 확인하여 기준값과 비교한다.
(3) 계통의 저항을 변화시키는 것이 어려울 경우에는 유량과 압력을 결정하여 각각의 기준값과 비교한다.
(4) 진동값을 결정하여 기준값과 비교한다. 진동측정에는 광대역 신호를 사용하며，속도 측정일 경우는 최대값을，변위 측정일 경우에는 정점사이의 값을 취한다.
(5) 기준값과의 편차는 표 MOB 5300에 있는 제한치와 비교하여 MOB 6200에 따라 시정조치를 한다. 진동 측정값은 표 MOB 5300의 절대허용치 및 상대허용치와 비교하여야 한다. 예를 들어 진동이 6 Vr 또는 0.7 in./sec(1.7 cm/sec)를 넘으면 펌프는 조치범위에 해당한다.

MOB 5400 용적형펌프
표 MOB 5400-1 용적형펌프(왕복형 제외)시험 허용기준
| ||||||| |---|---|---|---|---|---|---| |시험 종류|회전속도|시험항목|허용범위|경고 범위|조치범위|| |^|^|^|^|^|하 한|상 한| |(1). (2)</br>A 군 시험|N/A|Q|0.95〜1.10                                    Qr|0.93<Q<0.95                                    Qr|< 0.93 Q</br>r|> 1.10 Qr| |^|N/A|P|0.93 〜 1.10                                    Pr|0.90< ^P<0.93                                ᅀP</br>r|< 0.90 AP</br>r|> 1.10 AP</br>r| |^|< 600 rpm|v</br>d|< 2.5 V</br>r|2.5 y <v< 6                                    V</br>r r</br>(10.5<V<22                                    mils)</br>(266.7 <V< 558.8                                    um)|-|> 6 Vr</br>(> 22                                    mils)</br>(558.8 iim)| |^|> 600 rpm|V</br>v</br>(V )</br>d|< 2.5 K|2.5 K<V< 6                                    Vr</br>(0.325<K<0.7                                    in./sec)</br>(0.8<y<1.7                                    cm/sec)|-|> 6 Vr</br>(> 0.78                                    in./sec)</br>(1.7 cm/sec)| |B 군시험|N/A|0，|0.90 〜 1.10                                    Qr|-|< 0.90 Q</br>r|> 1.10 Qr| |(1), ⑵</br>종합시험|N/A|Q|0.95-1.06 Q</br>r|0.93<0〈0.95                                    Qr|< 0.93 Q</br>r|> 1.06 Qr| |^|N/A|ᅀ P|0.93 〜 1.06                                    APr|0.90< ^P<0.93                                ᅀP</br>r|< 0.90 Pr|> 1.06 Pr| |^|< 600 rpm|v</br>d</br>(Vu)|< 2.5 V</br>r|2.5 V <V< 6                                    Vr</br>r</br>(10.5<V<22                                    mils)</br>(266.7 <V< 558.8                                    pm)|-|> 6 Vr</br>(> 22                                    mils)</br>(558.8 iim)| |^|> 600 rpm|V</br>v</br>(V )</br>d|< 2.5 V</br>r|2.5 V <V< 6                                    Vr</br>r</br>(0.325<K<0.7                                    in./sec)</br>(0.8< V<1.7                                    cm/sec)|-|> 6 V</br>r</br>(> 0.7                                    in./sec)</br>(1.7 cm/sec)|
주) Pr, Qr, Vr : 기준 값
<1> : 변위，Vp : 속도
<2> 회전속도 > 600 rpm의 변위한계，회전속도 < 600 rpm의 속도한계는 그림 MOB 5200 참조

표 MOB 5400-2 왕복펌프시험 허용기준
| ||||||| |---|---|---|---|---|---|---| |시험 종류|회전속도|시험항목|허용범위|경고 범위|조치범위|| |^|^|^|^|^|하 한|상 한| |A 군 시험|N/A|Q|0.95-1.10 Q</br>r|0.93<Q<0.95                                Qr|< 0.93 Qr|> 1.10 Qr| |^|N/A|P|0.93-1.10 P</br>r|0.90<P<0.93                                P</br>r|< 0.90 Pr|> 1.10 Pr| |^|N/A|v</br>d|< 2.5 Vr|2.5 K<V< 6                                V</br>r|-|> 6 Vr| |B 군시험|N/A|Q|0.90-1.10 Qr|-|< 0.90 Qr|> 1.10 Qr| |종합시험|N/A|Q|0.95-1.06 Qr|0.93<Q<0.95                                Q</br>r|< 0.93 Qr|> 1.06 Qr| |^|N/A|P|0.93 〜 1.06                                Pr|0.90<0<0.93                                Pr|< 0.93 Pr|> 1.06 Pr| |^|N/A|V</br>d</br>（Vv）|< 2.5 Vr|2.5 K<V< 6                                V</br>r|-|> 6 V</br>r|
주） Pr, Qr, Vr : 기준값

MOB 5401 시험 기간
(1) A군시험과 종합시험은 펌프의 상태가 최대한 안정된 후，각 펌프를 적어도 2분간 운전하여야 된다. 이 운전시간이 지난 후에 표 MOB 3000에서 요구하는 시험항목을 적어도 한번 이상 측정
또는 결정하여 기록하여야 한다. 
(2) B군시험은 펌프의 상태가 안정된 후 표 MOB 3000에서 요구하는 시험 항목을 적어도 한번 이상 측정 또는 결정하여 기록하여야 한다.
...
MOB 5410 가동전시험
측정해야 할 변수를 표 MOB 3000에 나타내었다.
(1) 용적형펌프는 표 MOB 3000에 지정된 항목에 대하여 펌프 설계압력 또는 이에 가까운 압력에서 기준값을 설정해야 한다.
(2) 진동측정은 기준점에서 만 측정한다.

MOB 5420 가등중시험

MOB 5421 A군 시험절차
A군 시험은 펌프가 정해진 기준점에 가능한 한 근접하여 운전되고，그리고 아래 항에서 기술한 바와 같이 기준점으로부터 일정범위 내에서 수행하여야 한다. 표 MOB 3000에 열거된 시험 항목을 아
래에 따라 결정하고，기록하여야 한다. 시험은 다음과 같이 수행하여야 한다.
(1) 정속구동의 경우에는 펌프가 전동기 정격속도로 운전될 때，변속 구동의 경우에는 전동기 속도가 기준점 속도 ±1 %에 도달했을 때 시험을 한다.
(2) 토출압력이 기준점의 +2% 또는 -1%를 초과하지 않는 범위 내에서 가능한 한 기준점에 근접하도록 계통의 저항을 변화시킨 후，유량을 확인하여 기준값과 비교한다.
(3) 계통의 저항을 변화시키는 것이 어려울 경우에는 유량과 압력을 결정하여 각각의 기준값과 비교한다.
(4) 진동값(변위 또는 속도)을 결정하여 기준값과 비교한다. 진동측정에는 광대역 신호를 사용하며，속도 측정일 경우에는 최대값을，변위 측정일 경우에는 정점사이의 값을 취한다.
(5) 기준값과의 편차는 표 MOB 5400-1 또는 5400-2에 있는 제한치와 비교하며，필요시 MOB 6200에 따라 시정조치를 한다. 왕복펌프의 진동 측정값은 표 MOB 5400-2의 경고범위나 조치 범위에 표기된 상대 허용치와 비교하여야 한다. 기타 용적형펌프의 진동 측정값은 표 MOB 5400-1 의 경고범위나 조치범위에 표기된 절대허용치 및 상대허용치와 비교하여야 한다. 예를 들어 진동이 6 Vr 또는 0.7 in./sec(1.7 cm/sec)를 넘으면 펌프는 조치범위에 해당한다.

MOB 5422 B군 시험절차
B군 시험은 펌프가 정해진 기준점에 가능한 한 근접하여 운전되고，그리고 아래 항에서 기술한 바와 같이 기준점으로부터 일정범위 내에서 수행하여야 한다. 표 MOB 3000에 열거된 시험 항목을 아래에 따라 결정하고，기록하여야 한다. 시험은 다음과 같이 수행하여야 한다.
(1) 정속구동의 경우에는 펌프가 전동기 정격속도로 운전될 때，변속 구동의 경우에는 전동기 속도가 기준점 속도 ±1 %에 도달했을 때 시험을 한다.
(2) 유량을 결정하여 기준값과 비교하여야 한다.
(3) 기준점에 가능한 한 근접하도록 계통 저항을 변화시킬 수 있다. 토출압력이 기준점의 +1% 또는 -2%를 초과하지 않는 범위 내에서 가능한 한 기준점에 근접하도록 계통의 저항을 변화시켜야 한다.
(4) 기준값과의 편차는 표 MOB 5400에 있는 제한치와 비교하며，MOB 6200에 따라 시정조치를 하여야 한다.

MOB 5423 종합 시험절차
종합시험은 펌프가 정해진 기준점에 가능한 한 근접하여 운전되고，그리고 아래 항에서 기술한 바와 같이 기준점으로부터 일정범위 내에서 수행하여야 한다. 표 MOB 3000에 열거된 시험 항목을 아래에 따라 결정하고，기록하여야 한다. 시험은 다음과 같이 수행하여야 한다
(1) 정속구동의 경우에는 펌프가 전동기 정격속도로 운전될 때，변속 구동의 경우에는 전동기 속도가 기준점 속도 ±1 %에 도달했을 때 시험을 한다.
(2) 토출압력이 기준점의 +2% 또는 -1%를 초과하지 않는 범위 내에서 가능한 한 기준점에 근접하도록 계통의 저항을 변화시킨 후，유량을 확인하여 기준값과 비교한다.
(3) 계통의 저항을 변화시키는 것이 어려울 경우에는 유량과 압력을 결정하여 각각의 기준값과 비교한다.
(4) 진동값을 결정하여 기준값과 비교한다. 진동측정에는 광대역 신호를 사용하며，속도 측정일 경우는 최대값을，변위 측정일 경우에는 정점사이의 값을 취한다.
...
MOB 6100 경향분석
표 MOB 3000에 열거한 시험변수는 고정값만 제외하고, 모두 변화하는 경향을 분석하여야 한다.

MOB 6200 시정조치

MOB 6210 경고범위
시험결과가 표 MOB 5200, 표 MOB 5300 또는 표 MOB 5400의 경고범위 내에 들 경우 편차의 원인을 확인하고，시정조치를 완료하거나 MOB 6230에 따라 펌프해석을 수행할 때까지 MOB 3500의 시험 주기를 1/2로 하여야 한다.

MOB 6220 조치범위
시험결과가 표 MOB 5200, 표 MOB 5300 또는 표 MOB 5400의 조치범위에 해당할 경우 편차의 원인을 확인하고 시정조치하거나，MOB 6230에 따라 펌프 해석을 수행할 때까지 펌프는 운전불능으로
판정하여야 한다.

MOB 6230 해석
펌프시험 변수가 표 MOB 5200, 표 MOB 5300 또는 표 MOB 5400의 경고범위 또는 조치범위 내에 있을 때，변화된 값에서 펌프의 계속사용을 위한 해석을 수행할 수 있다. 물론 이 해석에는 펌프의 안전기능 수행능력 확인도 포함시켜야 하며，펌프 및 계통 측면의 운전 가능성뿐만 아니라 펌프성능 변화원인，데이터에 의한 경향분석도 포함하여야 한다. 해석에서는 또한 새로운 기준값을 설정해야 하는지를 고려하고，가능하면 새 기준값의 타당성을 증명해야 한다. 이 해석의 결과는 시험기록에 기재하여야 한다.（MOB 9000 참조）

MOB 6300 구조적 오류
시험결과가 허용범위 이상의 큰 편차를 보일 때（표 MOB 5200, 표 MOB 5300 또는 표 MOB 5400 참조），부적절한 계통 정렬 또는 부정확한 계기 사용 등과 같은 구조적 오류로 판명되면 오류를 수정하고，재시험 하여야 한다.

MOB 6400 관련 조건의 분석
만약，어떤 변수의 기준값이 다른 조건 때문에 현저하게 영향을 받을 수 있다면 이러한 조건들을 분석하고（1）시험결과에 기록하여야 한다.（MOB 9000 참조）주 （1） 펌프의 진동 측정은 기초，구동기 및 배관의 영향을 받을 수 있다. 만약 초기 진동 측정값이 높고，이 원인이 펌프 자체의 문제가 아닌 것이 분명할 시에는 구동기，기초 및 배관에서의 진동을각각 측정，분석하여 측정된 진동값이 펌프의 기능을 저해하지 않고，기준값이 펌프의 진동값을 대표한다는 것을 입증하여야 한다.
...
MOB 9100 펌프 기록
발전사업자는 이 기술기준을 적용하는 각 펌프에 대하여 다음 사항을 포함하는 기록을 유지하여 한다.
(1) 제작자, 제작자의 제품형식이나，일련번호 또는 식별번호
(2) 가능하다면 제작자의 시험 보고서 사본 또는 요약
(3) 펌프 제작자의 운전 제한치
(4) 펌프종합시험 유량 근거 (유량 및 관련된 차압 또는 토출압 그리고 가변속 펌프의 속도)

MOB 9200 시험 계획서
M0A 3110 및 M0A 3160 요건에 추가하여 시험계획서 및 절차서는 다음 사항을 포함하여야 한다.
(1) 펌프의 분류
(2) 사용될 유로
(3) 시험하여야하는 변수 각각에 대한 측정 위치 및 방법
(4) 계측설비로 직접 측정할 수 없는 시험변수 값을 결정하는 방법
...
1-1000 목적
이 부록은 펌프 주기적 검증 시험을 수행하기 위한 요건을 규정하고 있다. MOB 1400에서 설명한 것처럼，발전사업자는 MOA 1100에 따라 시험되는 적용 가능한 펌프에 대해서 펌프 주기적 검증시험 프로그램을 수립해야 한다. 

1-2000 용어정의
펌프 주기적 검증시험(2) : 가장 높은 설계기준사고 유량에서，펌프가 요구되는 압력(차압 또는 토출압)을 만족할 수 있는지 대해 검증하는 시험 

1-3000 일반요건
발전사업자는 다음사항을 수행하여야 한다.
(1) 신뢰할 수 있는 발전사업자의 안전 분석(기술사양，기술요건 프로그램 또는 최신 안전분석 보고서)에 특정 설계 기준 사고 유량을 가지는 펌프 제시한다.
(2) 적어도 2년 한번씩 펌프 주기적 검증 시험을 수행하여야 한다.
(3) 펌프가 교체，수리 또는 유지보수 후에 사용가능하다고 선언하기 전에 펌프 주기적 검증 시험이 필요한지 결정해야 한다.
(4) 만약，펌프 주기적 검증 시험 유량 그리고 관련된 차압(또는 용적형 펌프의 경우 토출압)이 달성되지 못했다면，펌프운전 불능을 선언해야 한다.
(5) 적용 가능한 시험 변수(유량과 관련한 토출압，또는 유량과 관련한 차압 그리고 가변속 펌프의 속도) 및 그들의 기준들을 포함하여，펌프 주기적 검증 시험에 필요한 기록들은 유지되어야 한다.
(6) 펌프 주기적 검증 시험 기기의 정확도가 시험 허용기준 범위 안에 있음을 밝혀야 한다.

주 (1) 이 부록에는 MOB의 역할을 늘리기 위해 요건들을 수록하고 있다. 만약 발전사업자 안전분석에 나와 있는 설계기준사고 유량이 펌프종합시험이나 A군 시험에 의해 제한되어 있다면，발전사업자는 펌프 주기적 검증시험을 수행할 필요는 없다.
(2) 펌프는 다른 계통사양 또는 single vs parallel 펌프 운전에서 기인한 여러 설계기준 사고 후 운전점을 가질 수 있다. 발전소 계통의 시험을 대해 추가적인 정보를 얻기 위해서는 KEPIC MOF “원전 계통성능시험”을 참고하시오.